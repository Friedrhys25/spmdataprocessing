  ...
  return (
    ...
    >
      <div className="movie-poster">
        {movie.poster_path && movie.poster_path !== "nan" ? (
          <img src={`https://image.tmdb.org/t/p/w300${movie.poster_path}`} alt={movie.title} onError={e => { e.target.style.display = "none"; e.target.nextSibling.style.display = "flex"; }} />
        ) : null}
        <div className="movie-poster-fallback" style={{ display: movie.poster_path && movie.poster_path !== "nan" ? "none" : "flex" }}>
          <FilmIcon />
